  ...
  return (
    <div className="min-h-dvh bg-white text-zinc-950 dark:bg-zinc-950 dark:text-zinc-50">
      <header className="border-b border-zinc-200 dark:border-zinc-800">
        <div className="mx-auto grid max-w-4xl gap-3 px-6 py-4 sm:flex sm:items-center sm:justify-between sm:gap-4">
      ...
      <footer className="border-t border-zinc-200 dark:border-zinc-800">
        <div className="mx-auto flex max-w-4xl flex-col gap-4 px-6 py-10 text-sm leading-6 text-zinc-500 sm:flex-row sm:items-end sm:justify-between dark:text-zinc-400">
          <div>
